# Michele's authored works catalog

**Purpose:** The full list of every book, curriculum, workbook, and produced project Michele has authored, overseen, or shepherded into the world. This file is the source for `/works` on the site and for the case-study index at `content/case-studies/00-index.md`.

**Scope:** Michele has explicit permission to promote all her authored work on `micheleokimura.com` in her capacity as founder of Michele Okimura LLC and founder and Executive Director of Releasing Generations. The site does not distinguish which IP sits under which entity. That is legal backend; readers do not need to know.

**Content note:** Each item below is a case study of Michele's ability to produce transformational written content. Together they form the authority stack.

---

## Trade books (published)

### 1. Dancing with Father
...
- **Positioning:** An illustrated poetic book of healing for women.
- **Case study:** `content/case-studies/dancing-with-father.md`

### 2. The Birth of Explicit Movement
- **Author:** Michele Okimura
- **Publisher:** Explicit Movement / Releasing Generations imprint
- **Publication date:** 2018
- **Subtitle:** Discover Keys to Fulfilling Your Purpose
- **Format:** Paperback and e-book
- **Positioning:** The founding story and core teaching of Explicit Movement. Memoir plus framework.
- **Case study:** `content/case-studies/birth-of-explicit-movement.md`

### 3. Explicit Movement 21-Day Interactive Journal
- **Author:** Michele Okimura
- **Publication date:** 2018
- **Format:** Print $14.99, e-book $9.99
...
- **Word count target:** ~55,000
- **Structure:** 15 chapters in three Parts (Discovering the Dreamer Within / From Dreamer to Builder / Living Your Dream), plus frontmatter and backmatter
...
- **Format:** Trade paperback, e-book, audiobook (planned)
- **Word count target:** ~55,000
- **Structure:** Parallel to the secular edition with the Holy Spirit, Jesus, and Scripture woven throughout
- **Positioning:** The faith companion. For Christian readers walking the healing-to-purpose road.
- **Case study:** `content/case-studies/dream-big-with-god.md`
...
- **Sold via:** `micheleokimura.square.site/shop/dream-big-journals`
...
- **Sold via:** `braveandbeautiful.world` and `braveseries.square.site`
...
- **Sold via:** `braveseries.square.site`
...
- **Sold via:** `braveseries.square.site`
- **Positioning:** Coed teen leadership curriculum focused on shared identity and mission.
- **Case study:** `content/case-studies/brave-together.md`
...
- **Case study:** `content/case-studies/wisdom-flows.md`
...
## In production or forthcoming

- Companion workbooks for *Brave Purpose* and *Brave Purpose with God*.
- Francis Oda memoir (Michele co-developing).
- *Tried-and-True Love* under the Ohana Style Publishing imprint.

## Notes for Brett

- Every case study file in `content/case-studies/` follows the same structure. See `content/case-studies/00-index.md` for the template.
- Cover images sit in `assets-raw/current-site-archive-2026-06-26/images/books/` for the published items. Missing covers get a `TODO.md` in the appropriate subfolder naming the file to request from Michele.
- "Coming soon" is the acceptable placeholder for unpublished works. Do not fabricate cover art or release dates.
