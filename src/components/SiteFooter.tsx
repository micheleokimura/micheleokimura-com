        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 lg:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xs text-sm leading-6 text-neutral-600">
              Michele takes on a small number of coaching clients and speaking
              dates. Drop your info and she will reach out personally when a spot
              opens.
            </p>
            <div className="mt-5">
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                aria-label="Michele on LinkedIn"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Michele on Instagram"
                className="text-neutral-500 transition hover:text-neutral-950"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Michele on Facebook"
                className="text-neutral-500 transition hover:text-neutral-950"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
