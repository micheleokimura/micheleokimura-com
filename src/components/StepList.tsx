...
export function StepList({ steps }: { steps: Step[] }) {
  return (
    <div className="mt-24 sm:mt-32 lg:mt-40 -mx-6 bg-neutral-950 surface-teal py-24 sm:py-32 sm:mx-0 sm:rounded-4xl">
      <Container>
          ...
          <ol role="list" className="mt-20 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-5">
            {steps.map((step) => (
              <FadeIn as="li" key={step.number}>
                <div>
                  <p className="font-display text-5xl font-semibold tracking-tight text-[var(--color-brand-terracotta-on-dark)]">
                    {step.number}
                  </p>
