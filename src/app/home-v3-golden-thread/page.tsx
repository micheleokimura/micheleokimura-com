...
/**
 * Home page design variant 3 of 3: POSITIONING-FORWARD.
 *
...
export const metadata: Metadata = {
  title: 'Home variant 3 · Golden thread',
  description:
    'Positioning-forward home page design for review. The golden thread leads, and every section restates it.',
...
export default function HomeGoldenThreadVariant() {
  return (
    <>
      {/* ------------------------------------------------------------- hero */}
